...
from config import API_HASH, APP_ID, LOGGER, TG_BOT_TOKEN, TG_BOT_WORKERS, FORCE_SUB_CHANNEL, FORCE_SUB_CHANNEL3, FORCE_SUB_CHANNEL2, CHANNEL_ID, PORT
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL2:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/HG_ANIME_DISCUSSION for support")
                sys.exit()

        if FORCE_SUB_CHANNEL3:
            try:
                link = (await self.create_chat_invite_link(chat_id=FORCE_SUB_CHANNEL3, creates_join_request=True)).invite_link 
